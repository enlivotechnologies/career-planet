...
import { MessageCircle, Send, Mail, Phone, MapPin, ArrowRight } from "lucide-react";
            ...
            <div className="lg:col-span-5 flex flex-col justify-end pb-4">
                ...
                <div className="space-y-6 pl-1">
                    ...
                    <div className="group flex items-center gap-5 cursor-pointer">
                        ...
                        <div>
                            <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">Visit Us</h4>
                            <p className="text-lg font-medium text-black leading-snug max-w-xs">
